...
@EventBusSubscriber(modid = "astralexpanse", value = Dist.CLIENT)
public class AstralArmorAbilityHandler {
    ...
    public static void onRightClick(PlayerInteractEvent.RightClickItem event) {
        ...
        if (player.isShiftKeyDown() && VoidiniumSpecialArmor.hasVoidiniumArmor(player)) {
