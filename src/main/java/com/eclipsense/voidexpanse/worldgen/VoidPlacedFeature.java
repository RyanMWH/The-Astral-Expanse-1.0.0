...
public class VoidPlacedFeature {
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> context){
        ...
        register(context, END_VOIDINIUM_ORE_PLACED_KEY, configuredFeature.getOrThrow(VoidConfiguredFeature.END_VOIDINIUM_ORE_KEY),
                rareEndOrePlacement());
    ...
    public static ResourceKey<PlacedFeature> registerKey(String name) {
        return ResourceKey.create(Registries.PLACED_FEATURE, ResourceLocation.fromNamespaceAndPath(VoidExpanse.MODID, name));
    }
